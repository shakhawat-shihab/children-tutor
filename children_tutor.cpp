...
void optionAlphabet()
{
    ...
    setcolor(WHITE);
    outtextxy(70,170,"PRESS ANY LETTER, ");
    settextstyle(DEFAULT_FONT,HORIZ_DIR,2);
    outtextxy(120,200,"-FOR ALPHABET LEARNING.");
    setcolor(RED);
    settextstyle(SIMPLEX_FONT,HORIZ_DIR,3);
    outtextxy(70,270,"PRESS '0' FOR GO BACK.");
//    outtextxy(110,200,"PRESS 2 FOR CEXIT");
}
void optionGeometry()
{
    settextstyle(DEFAULT_FONT,HORIZ_DIR,2);
    outtextxy(110,100,"PRESS 1 FOR GEOMETRY LEARNING");
    outtextxy(110,200,"PRESS 2 FOR SKILL TEST");
}
void optionMathematics()
{
    setcolor(GREEN);
    ...
    settextstyle(DEFAULT_FONT,HORIZ_DIR,2);
    setcolor(15);
    outtextxy(50,120,"PRESS 1 TO LEARN ADD OF TWO DIGIT");
    outtextxy(50,180,"PRESS 2 TO LEARN SUBTRACTION OF TWO DIGIT");
    setcolor(RED);
    outtextxy(50,310,"PRESS x TO GO BACK");
    // showmth();
}
void mainMenu()
{
